...
func on_ammo_consumed():
    ...
    dash_slide_speed_buff.modified_stat_name = "dash_slide_speed_modifier"
    dash_slide_speed_buff.value = bonus_dash_speed_perc
    dash_slide_speed_buff.modify_type = StatusEffect.StatusEffectModifyType.PERCENTAGE
    ...
    run_speed_buff.modified_stat_name = "run_speed_modifier"
    run_speed_buff.value = bonus_run_speed_perc
    run_speed_buff.modify_type = StatusEffect.StatusEffectModifyType.PERCENTAGE
