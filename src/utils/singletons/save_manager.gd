...
func save_setting_config():
	...
	config.set_value("Graphic", "screen_shake_toggle", !GameManager.screen_shake_disabled)
	config.set_value("Graphic", "drunk_blur_toggle", !GameManager.drunk_blur_disabled)
...
func load_setting_config():
	...
	GameManager.screen_shake_disabled = !config.get_value("Graphic", "screen_shake_toggle")
	GameManager.drunk_blur_disabled = !config.get_value("Graphic", "drunk_blur_toggle")
