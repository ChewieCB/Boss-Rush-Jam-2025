...
func save_setting_config():
	...
	config.set_value("Control", "mouse_controller_override", GameManager.mouse_controller_override)
...
func load_setting_config():
	...
	GameManager.mouse_controller_override = config.get_value("Control", "mouse_controller_override", false)
